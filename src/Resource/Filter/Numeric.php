 ...
 * deserializer and the matching `numeric()` value constraint and building a plain
 * {@see Where}, so coercion, validation and the OpenAPI value schema all come from
 * one declaration; a handler's existing `instanceof Where` arm dispatches it unchanged.
 *
 ...
 */
final class Numeric extends WhereBuilder
{
