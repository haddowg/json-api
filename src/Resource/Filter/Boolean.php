 ...
 *
 * A {@see WhereBuilder} facade presetting the `=` operator, the boolean coercion
 * deserializer ({@see WhereBuilder::asBoolean()}) and the matching `boolean()`
 * value constraint and building a plain {@see Where}, so coercion, validation and
 * the OpenAPI value schema all come from one declaration; a handler's existing
 ...
 */
final class Boolean extends WhereBuilder
{
