...
/**
 * The mutable **filter builder** for a {@see WhereIn} value filter. {@see build()}
 * freezes the accumulated state into the readonly {@see WhereIn} value object.
 */
final class WhereInBuilder implements FilterBuilderInterface
{
    ...
    public function build(): WhereIn
    {
        return new WhereIn($this->key, $this->column, $this->delimiter, $this->singular, $this->default, $this->hasDefault, $this->constraints, $this->description, $this->hasExample, $this->example);
    }
